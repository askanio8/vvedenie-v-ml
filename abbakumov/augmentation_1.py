...
# Добавляет в тензор ещё одно измерение в начало зачем-то
# Скорее всего созданная сеть предобработки принимает тензор - коллекцию тензоров экземпляров, то есть тензор
