...
# В 12 столбцах из 102 значение меньше, чем количество строк. Это значит что событие (покупка или установка
...
# radiant_bottle_time, radiant_courier_time, radiant_flying_courier_time, radiant_first_ward_time
# dire_bottle_time, dire_courier_time, dire_flying_courier_time, dire_first_ward_time
# 2. Столбец с целевой переменной - radiant_win. Но можно уйти от задачи классификации к задаче регресии,
...
# признаков, то можно ускорить обучение. С параметрами n_estimators=1000, learning_rate=0.2, max_depth=2,
# max_features=4 разница 3% - AUC=0.72